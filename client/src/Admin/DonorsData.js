...
function DonorsData(){
      ...
      useEffect(() => {
        axios.get(`http://localhost:4000/read3`)
            .then((response) => {
   ...
   const  deletereg = (id) => {
    ...
    return(
      ...
      <div style={{position:'relative',marginLeft:'200px',marginTop:'-700px', fontFamily:'Verdana'}}>
          <h2 style={{color:'#008080',marginLeft:'500px',fontSize:'30px', position:'relative', bottom:'50px'}}>Donor Data</h2>
